...
func defaultPageContents() []models.PageContent {
	return []models.PageContent{
		...
		},
		{
			...
			Title:       "Cookie Red",
			Subtitle:    "Os mais amados!",
			Description: "Cookie artesanal com chocolate branco e notas suaves de baunilha.",
		...
		},
		{
			...
			Subtitle:    "Os mais amados!",
			Description: "Cookie artesanal com chocolate belga ao leite, crocante por fora e derretido por dentro.",
		...
		},
		{
			...
			Subtitle:    "Os mais amados!",
			Description: "Cookie artesanal com massa de cacau 70% e gotas de chocolate meio amargo.",
