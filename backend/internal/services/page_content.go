	...
	return []models.PageContent{
		{
			...
			Name:        "Hero principal",
			Section:     "Hero",
			Title:       "Cookies que fazem sorrir",
			Subtitle:    "Cookies & Coffee Break",
			Description: "Feitos à mão com ingredientes de verdade, muito amor e uma pitada de magia. Cada mordida é um abraço quentinho.",
			Image:       "cookie-home.png",
			ButtonText:  "Ver cookies",
			ButtonLink:  "/shopping",
			Status:      "Ativo",
		},
		{
		...
		},
		{
			...
			Section:     "Depoimentos",
			Title:       "Ana Clara",
			Description: "“Gente, eu CHOREI comendo o de caramelo salgado. Não é exagero. É viciante demais! 🥹”",
			Status:      "Ativo",
		},
		{
			Page:        "landing",
		...
		},
		{
			...
			Name:        "CTA principal",
			Section:     "CTA Final",
			Title:       "Tá esperando o que pra experimentar?",
			Subtitle:    "Peça online e receba seus cookies quentinhos em minutos.",
			Description: "Delivery ou retirada — você escolhe!",
