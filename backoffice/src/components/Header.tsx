        ...
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-4 py-3 md:px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/home" className="flex items-center gap-3 group transition ">
              <img src={BrandLogo} alt="Brand Logo" className="w-15 h-15 rounded-full transition group-hover:contrast-75" />
              <div className="hidden sm:block group-hover:scale-105 transition-transform">
                ...
                <h1 className="font-comfortaa text-sm leading-tight tracking-wide text-text-h">DonnaLupe</h1>
              </div>
            </Link>
          </div>
            ...
            {isAuthenticated && (
              <>
                <div className="flex items-center gap-2.5">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-primary text-xs font-bold text-primary-contrast shadow-lg">
                    {initials}
                  </div>
                  ...
                  className={({ isActive }) =>
                    `flex items-start gap-4 px-4 py-4 rounded-xl transition-all duration-200 outline-none focus-visible:ring-2 focus-visible:ring-primary ${
                      isActive
                        ...
                        : "border border-transparent text-muted hover:bg-secondary/10 hover:text-text"
                    }`
                  }
                >
                  {({ isActive }) => (
                    <>
                      <span 
                        className={`rounded-lg p-2 ${isActive ? "bg-primary/10 text-primary" : "bg-secondary/10 text-muted"}`} 
                        aria-hidden="true"
                      >
                        {tab.icon}
                      </span>
