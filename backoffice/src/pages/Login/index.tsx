...
export default function LoginPage() {
  ...
  return (
    <section className="relative flex min-h-[calc(100vh-73px)] items-center justify-center overflow-hidden px-4 py-12">
      ...
      <div className="absolute -left-1/4 top-0 h-96 w-96 rounded-full bg-[color-mix(in_oklab,var(--secondary)_22%,transparent)] blur-[120px]" />
      <div className="absolute -right-1/4 bottom-0 h-96 w-96 rounded-full bg-[color-mix(in_oklab,var(--accent)_22%,transparent)] blur-[120px]" />
      ...
      <Card className="relative grid w-full max-w-5xl gap-0 overflow-hidden rounded-3xl border p-0 md:grid-cols-[1fr_0.9fr]">
        ...
        <div className="relative flex flex-col justify-between bg-[linear-gradient(160deg,color-mix(in_oklab,var(--primary)_78%,black_22%),color-mix(in_oklab,var(--secondary)_84%,black_16%))] p-8 text-white md:p-12">
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <h1 className="text-4xl font-extrabold tracking-tight md:text-5xl lg:text-6xl">
                LUDOGS <span className="mt-2 block text-3xl font-medium text-[#ffe9d6] underline decoration-[#f6c39f]/70 underline-offset-8 md:text-4xl">Backoffice</span>
              </h1>
            </div>
            
            <p className="max-w-[320px] text-lg leading-relaxed text-[#fcebdc]/85">
              Gerenciamento centralizado e seguro dos dados da loja de doces Ludogs.
            </p>
          </div>

          <div className="mt-12 flex items-center gap-3 text-sm text-white/75">
            <div className="h-2 w-2 animate-pulse rounded-full bg-[#ffd6b8]" />
        ...
        <div className="flex flex-col justify-center bg-(--surface)">
          ...
          <div className="p-8 md:p-12">
            ...
            <p className="mt-8 text-center text-xs text-(--muted)">
              &copy; {new Date().getFullYear()} Ludogs - Todos os direitos reservados.
            </p>
          </div>
        </div>
      </Card>
